      ...
      <div className="min-h-screen bg-white">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between h-16">
              ...
              <div className="hidden md:flex items-center space-x-8">
                ...
                <button className="bg-blue-900 text-white px-6 py-2 rounded-lg hover:bg-blue-800 transform hover:scale-105 transition-all duration-300">
                  Get Quote
                </button>
              </div>
        ...
        {/*  <div
          ...
          className={`py-20 bg-white animate-on-scroll ${
            isVisible["contact-section"] ? "animate-fadeIn" : "opacity-0"
          }`}
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
