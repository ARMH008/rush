...
import { Archive, ChartColumnDecreasing, UserSearch } from "lucide-react";
            ...
            {(userData?.user?.role === "admin" ||
              ...
              <>
                ...
                >
                  ...
                  <ChartColumnDecreasing className="group-hover:transform group-hover:rotate-90 h-6 w-6 mr-2" />
                  Chart
                </Link>
                <Link
                  to="detailchart"
                ...
                >
                  ...
                  <UserSearch className="group-hover:transform group-hover:rotate-180 h-6 w-6 mr-2" />
                  User Management
                </Link>
                <Link
                  to="reportManagement"
                  className="flex items-center px-4 py-2 mt-2 text-gray-100 hover:bg-indigo-600 group"
                >
                  <Archive className="group-hover:transform group-hover:rotate-180 h-6 w-6 mr-2" />
                  Report Management
                </Link>
              </>
            )}
