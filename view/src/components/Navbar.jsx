...
const Navbar = () => {
  ...
  return (
    <nav className="relative bg-white shadow-lg">
      ...
      <div
        className={`absolute top-0 left-0 w-full h-full bg-white transform transition-transform duration-300 ease-in-out lg:relative lg:transform-none lg:flex lg:items-center ${
      ...
      >
        ...
        <ul className="flex flex-col gap-4 items-center justify-center h-full lg:flex-row lg:gap-8">
          <li>
            <a
              href="#home"
