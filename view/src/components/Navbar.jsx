...
const Navbar = ({ userData }) => {
  ...
  return (
    <div className="sticky top-0 z-50 shadow-md realtive ">
      <nav className="relative px-4 py-4 flex justify-between items-center bg-white">
        ...
        > */}
          <li>
            <Link
              className="text-l text-gray-700  hover:text-blue-600 hover:font-bold "
              to="/"
            >
              Home
            </Link>
        ...
        {userData?.status === "success" ? (
          <>
            ...
            <Link
              className="hidden lg:inline-block  py-2 px-6 bg-red-500 hover:bg-gray-100 text-sm text-gray-900 font-bold  rounded-xl transition duration-200"
              to="/logout"
            >
              Logout
            </Link>
              ...
              <div className="pt-6">
                {userData?.status === "success" ? (
                  <>
                    ...
                    <Link
                      className="block px-4 py-3 mb-2 leading-loose text-xs text-center text-white font-semibold bg-red-600 hover:bg-red-900  rounded-xl"
                      to="/logout"
                    >
                      Log out
                    </Link>
